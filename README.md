...
| `skills/` | Thirteen stack/workflow skills + `skill-creator` + the 14-skill superpowers bundle vendored verbatim from obra/superpowers (needs `steering/superpowers-bootstrap.md` to trigger) | `~/.kiro/skills/<name>/` |
