...
| `skills/` | Eleven stack/workflow skills, the `superpowers` methodology bundle (ported from obra/superpowers), plus `skill-creator` (already structured for direct copy) | `~/.kiro/skills/<name>/` or `.kiro/skills/<name>/` |
